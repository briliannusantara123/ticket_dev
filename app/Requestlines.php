...
class Requestlines extends Model
{
    ...
    protected $fillable =['code','id_header','id_company','id_project','description','status','id_developer','date_solve','date_close','gambar','email_client','email_consultant','message_testing','date_cancel','user_id','solve_by','dead_line','message_client','ticket_paid'];
