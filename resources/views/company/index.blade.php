                ...
                <div class="panel-body">
                      ...
                      <th>Action</th>
                        ...
                        <td>
													...
													<a href="/ticket/company/{{$company->idc}}/edit" class="btn btn-warning mt-3">View</a>
													<a href="/ticket/company/{{$company->idc}}/delete" class="btn btn-danger mt-3" onclick="return confirm('Yakin Akan Menghapus Data mcompany Tersebut?');">Hapus</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form action="/ticket/company/create" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
