                      ...
                      <th>Code</th>
                        ...
                        <td>{{$typesupport->code}}</td>
												...
												<td>
													...
													<a href="/ticket/typesupport/{{$typesupport->id}}/edit" class="btn btn-warning mt-3">View</a>
													<a href="/ticket/typesupport/{{$typesupport->id}}/delete" class="btn btn-danger mt-3" onclick="return confirm('Yakin Akan Menghapus Data mtypesupport Tersebut?');">Hapus</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form action="/ticket/typesupport/create" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
