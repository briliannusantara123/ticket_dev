						...
						<div class="panel">
							<div class="panel-heading">
								...
								<div class="panel-body">
									...
									<a href="/ticket/projects" class="btn btn-danger">Kembali</a>
										...
										@if($p_relation->count())
											...
											<tr>
												...
												<td>@if($pr->role == 1)
													...
													@endif</td>
						                        <td>
													<a href="/ticket/pr/{{$pr->id}}/delete_pr" class="btn btn-danger mt-3">Delete</a>
												</td>
											</tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form action="/ticket/pr/post" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
              <input type="hidden" name="id_project" value="{{$projects->id}}">
  				<div class="form-group">
		                
		                 <select name="id_user" class="form-control"class="form-control form-control-md" id="keperluan" onchange='consultantValue(this.value)'>
		            ...
		            <div class="form-group">
		                 ...
		                 <select name="id_user_developer" class="form-control"class="form-control form-control-md" id="developer" onchange='changeValues(this.value)'>
		            ...
		            <input type="hidden" name="pilih1" id="pilih1">

		            <input type="hidden" name="emails" id="emails">
		            <input type="hidden" name="id_jabatans" id="roles">
		            <input type="hidden" name="pilih2" id="pilih2">
					  ...
					  <button type="submit" class="btn btn-primary">Submit</button>
							...
							<script type="text/javascript">
						        ...
						        function consultantValue(id){
						            ...
						            document.getElementById('pilih1').value = prdNameConsultant[id].role;
						        }
						        </script>
						        <script type="text/javascript">
						         <?php echo $jsArray; ?>
						        function changeValues(id){
						            ...
						            document.getElementById('pilih2').value = prdName[id].role;
						        }
						        </script>  
@stop