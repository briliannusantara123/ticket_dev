              ...
              <div class="panel-heading">
                ...
                <div class="panel-body">
                      ...
                      <th>Ticket Active</th>
                        ...
                        <td>{{$projects->code}}</td>
												<td>{{$projects->nama}}</td>
												<td><a href="/ticket/pr/{{$projects->id}}/p_relation">{{$projects->nama_projects}}</a></td>
                        ...
                        @endif
												...
												<td>
													...
													<a href="/ticket/projects/{{$projects->id}}/edit" class="btn btn-warning mt-3">View</a>
													<a href="/ticket/projects/{{$projects->id}}/delete" class="btn btn-danger mt-3" onclick="return confirm('Yakin Akan Menghapus Data mprojects Tersebut?');">Hapus</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form action="/ticket/projects/create" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
