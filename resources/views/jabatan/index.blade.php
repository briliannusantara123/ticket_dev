                      ...
                      <th>Code</th>
                        ...
                        <td>{{$jabatan->code}}</td>
												...
												<td>
													...
													<a href="/ticket/jabatan/{{$jabatan->id}}/edit" class="btn btn-warning mt-3">View</a>
													<a href="/ticket/jabatan/{{$jabatan->id}}/delete" class="btn btn-danger mt-3" onclick="return confirm('Yakin Akan Menghapus Data mjabatan Tersebut?');">Hapus</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form action="/ticket/jabatan/create" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
