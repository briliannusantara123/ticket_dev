                ...
                <div class="panel-body">
                  ...
                  <form class="row g-3" method="GET">
                    <label class="form-label">Filter Data</label>
                     <select name="status" class="form-control">
                      ...
                      <?php endif ?>
                     ...
                     </select> <button type="submit" class="btn btn-primary md-12">Search</button>
                  </form>           
                                </div>
              </div>
                                <br>
                        ...
                        <td>{{$transaksi->message_admin}}</td>
                          ...
                          @if(auth()->user()->role == 4)
                           @if($transaksi->status == 1)
                           <a href="/ticket/transaksi/{{$transaksi->id}}/edit" class="btn btn-warning mt-3">Edit</a>
                           @endif
                          @endif
                          @if(auth()->user()->role == 2)
                           @if($transaksi->status == 6)
                           ...
                           @else
                                                    <a href="/ticket/transaksi/{{$transaksi->id}}/edit" class="btn btn-warning mt-3">View</a>
                          @endif
                                                    @endif
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form action="/ticket/transaksi/create" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
