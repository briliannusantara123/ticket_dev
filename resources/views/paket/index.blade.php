                ...
                <div class="panel-body">
                      ...
                      <th>Masa Aktif</th>
                        ...
                        <td>{{$paket->code}}</td>
												...
												<td>{{$paket->harga}}</td>
												<td>{{$paket->ticket}}</td>
                        <td>{{$paket->activedate}} Hari</td>
                        <td>
                          
													<a href="/ticket/paket/{{$paket->id}}/edit" class="btn btn-warning mt-3">View</a>
													<a href="/ticket/paket/{{$paket->id}}/delete" class="btn btn-danger mt-3" onclick="return confirm('Yakin Akan Menghapus Data ticket Tersebut?');">Hapus</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form action="/ticket/paket/create" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
