          ...
          <div class="col-md-12">
            <div class="panel">
              ...
              <div class="modal-body">
                <form action="/ticket/paket/{{$paket->id}}/update" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
              ...
              <div class="form-group">
                ...
                <input name="activedate"type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$paket->activedate}}" required="">

              </div>
              
              <div class="modal-footer">
              <a href="/ticket/paket" class="btn btn-danger">Kembali</a>
