          ...
          <div class="col-md-12">
            <div class="panel">
              ...
              <div class="modal-body">
                <form action="/ticket/requestlines/{{$rl->idl}}/update" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
             ...
             <div class="form-group">
                    <strong id="text">Developer</strong> 
                     <select name="id_developer" class="form-control"  id="id_developer">
                      ...
                      <option value="{{$developer->id_user}}">{{$developer->username}} </option>
                       @endif
                      @endforeach
                    </select>
                </div>
             ...
             <div class="form-group">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Date Solve</label>
                  <input type="date" name="date_solve" class="form-control" >
...
<div class="form-group">
    ...
    <input type="date" name="dead_line" class="form-control" value="{{$rl->dead_line}}">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label id="idm" hidden="">Message</label>
                  <textarea name="message_client" class="form-control" id="message_client" hidden=""></textarea>
                </div>
...
<script type='text/javascript'>
    ...
    $("#id_status").change(function() {
                ...
                if ($("#id_status option:selected").val() == '5') {
                    $('#message_client').prop('hidden', false);
                    $('#idm').prop('hidden', false);
                }else if ($("#keperluan option:selected").val() == '7') {
                    $('#idm').prop('hidden', 'true');
                    $('#message_client').prop('hidden', 'true');
